...
#class AddressSerializer(serializers.ModelSerializer)
    #class Meta:
        #model = Address
        #fields = ('id','Address_ID','Street_Address','City','State','Zip_Code','Country')
...
class Person_Historical_DiagnosticSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ('id','Dcode','Person_ID','Diagnosed_Date','Recovery_Status')
...
class Address_TypeSerializer(serializers.ModelSerializer):
    class Meta:
        model = Address_Type
        fields = ('id', 'address_type_id', 'name')


class Person_AddressSerializer(serializers.ModelSerializer):
    class Meta:
        model = Person_Address
        fields = ('id', 'Address_ID', 'organization_id', 'E_Mail', 'address_type_id', 'Person_ID')
